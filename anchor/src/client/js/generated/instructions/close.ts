...
export type CloseInput<
  ...
  TAccountSolanavotingapp extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountSolanavotingapp>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountSolanavotingapp> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.solanavotingapp),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountSolanavotingapp>;
...
> = {
  ...
  accounts: {
    ...
    solanavotingapp: TAccountMetas[1];
  };
